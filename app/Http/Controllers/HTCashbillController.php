<?php
/**
  * 팝빌 홈택스 현금영수증 API PHP SDK Laravel Example
  *
  * Laravel 연동 튜토리얼 안내 : https://developers.popbill.com/guide/htcashbill/php/getting-started/tutorial?fwn=laravel
...
class HTCashbillController extends Controller
{
    ...
    public function DeleteContact()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->DeleteContact($CorpNum, $TargetUserID, $UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();

...
class HTCashbillController extends Controller
{
    ...
    public function RequestJob()
    {
        ...
        try {
            $jobID = $this->PopbillHTCashbill->RequestJob($CorpNum, $CBType, $SDate, $EDate, $UserID);
    ...
    public function GetJobState()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->GetJobState($CorpNum, $jobID, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function ListActiveJob()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->ListActiveJob($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function Search()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->Search($CorpNum, $JobID, $TradeType, $TradeUsage, $Page, $PerPage, $Order, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function Summary()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->Summary($CorpNum, $JobID, $TradeType, $TradeUsage, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetCertificatePopUpURL()
    {
        ...
        try {
            $url = $this->PopbillHTCashbill->GetCertificatePopUpURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetCertificateExpireDate()
    {
        ...
        try {
            $ExpireDate = $this->PopbillHTCashbill->GetCertificateExpireDate($CorpNum);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function RegistDeptUser()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->RegistDeptUser($CorpNum, $deptUserID, $deptUserPWD, $UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function DeleteDeptUser()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->DeleteDeptUser($CorpNum, $UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function GetFlatRatePopUpURL()
    {
        ...
        try {
            $url = $this->PopbillHTCashbill->GetFlatRatePopUpURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetFlatRateState()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->GetFlatRateState($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetBalance()
    {
        ...
        try {
            $remainPoint = $this->PopbillHTCashbill->GetBalance($CorpNum);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetUseHistory()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->GetUseHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $Order, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('HTCashbill/UseHistoryResult', ['Result' => $result]);
    }
    ...
    public function GetPaymentHistory()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->GetPaymentHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('HTCashbill/PaymentHistoryResult', ['Result' => $result]);
    }
    ...
    public function GetRefundHistory()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->GetRefundHistory($CorpNum, $Page, $PerPage, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('HTCashbill/RefundHistoryResult', ['Result' => $result]);
    }
    ...
    public function Refund()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->Refund($CorpNum, $RefundForm, $UserID);
            $code = $result->code;
    ...
    public function PaymentRequest()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->PaymentRequest($CorpNum, $PaymentForm, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('HTCashbill/PaymentResponse', ['Result' => $result]);
    }
    ...
    public function GetSettleResult()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->GetSettleResult($CorpNum, $SettleCode, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('HTCashbill/PaymentHistory', ['Result' => $result]);
    }
    ...
    public function GetChargeURL()
    {
        ...
        try {
            $url = $this->PopbillHTCashbill->GetChargeURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetPaymentURL()
    {
        ...
        try {
            $url = $this->PopbillHTCashbill->GetPaymentURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetUseHistoryURL()
    {
        ...
        try {
            $url = $this->PopbillHTCashbill->GetUseHistoryURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetPartnerBalance()
    {
        ...
        try {
            $remainPoint = $this->PopbillHTCashbill->GetPartnerBalance($CorpNum);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetPartnerURL()
    {
        ...
        try {
            $url = $this->PopbillHTCashbill->GetPartnerURL($CorpNum, $TOGO);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetChargeInfo()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->GetChargeInfo($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function CheckIsMember()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->CheckIsMember($CorpNum, $LinkID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function CheckID()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->CheckID($UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function GetAccessURL()
    {
        ...
        try {
            $url = $this->PopbillHTCashbill->GetAccessURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetCorpInfo()
    {
        ...
        try {
            $CorpInfo = $this->PopbillHTCashbill->GetCorpInfo($CorpNum);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function UpdateCorpInfo()
    {
        ...
        try {
            $result =  $this->PopbillHTCashbill->UpdateCorpInfo($CorpNum, $CorpInfo, $UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function RegistContact()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->RegistContact($CorpNum, $ContactInfo, $UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function GetContactInfo()
    {
        ...
        try {
            $ContactInfo = $this->PopbillHTCashbill->GetContactInfo($CorpNum, $ContactID, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function ListContact()
    {
        ...
        try {
            $ContactList = $this->PopbillHTCashbill->ListContact($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function UpdateContact()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->UpdateContact($CorpNum, $ContactInfo, $UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function QuitMember()
    {
        ...
        try {
            $result = $this->PopbillHTCashbill->QuitMember($CorpNum, $QuitReason, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);

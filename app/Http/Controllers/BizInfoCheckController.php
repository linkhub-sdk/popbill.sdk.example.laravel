...
use Linkhub\Popbill\PopbillBizInfoCheck;
...
class BizInfoCheckController extends Controller
{
    public function __construct()
    {
        ...
        // 기업정보조회 서비스 클래스 초기화
        $this->PopbillBizInfoCheck = new PopbillBizInfoCheck(config('popbill.LinkID'), config('popbill.SecretKey'));

        // 연동환경 설정값, true-개발용, false-상업용
        $this->PopbillBizInfoCheck->IsTest(config('popbill.IsTest'));

        // 인증토큰의 IP제한기능 사용여부, true-사용, false-미사용, 기본값(true)
        $this->PopbillBizInfoCheck->IPRestrictOnOff(config('popbill.IPRestrictOnOff'));

        // 팝빌 API 서비스 고정 IP 사용여부, true-사용, false-미사용, 기본값(false)
        $this->PopbillBizInfoCheck->UseStaticIP(config('popbill.UseStaticIP'));

        // 로컬서버 시간 사용 여부, true-사용, false-미사용, 기본값(true)
        $this->PopbillBizInfoCheck->UseLocalTimeYN(config('popbill.UseLocalTimeYN'));
    }
    ...
    public function CheckBizInfo()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->CheckBizInfo($CorpNum, $TargetCorpNum);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('BizInfoCheck/CheckBizInfo', ['Result' => $result]);
    }
    ...
    public function GetBalance()
    {
        ...
        try {
            $remainPoint = $this->PopbillBizInfoCheck->GetBalance($CorpNum);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetUseHistory()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->GetUseHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $Order, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('BizInfoCheck/UseHistoryResult', ['Result' => $result]);
    }
    ...
    public function GetPaymentHistory()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->GetPaymentHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('BizInfoCheck/PaymentHistoryResult', ['Result' => $result]);
    }
    ...
    public function GetRefundHistory()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->GetRefundHistory($CorpNum, $Page, $PerPage, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('BizInfoCheck/RefundHistoryResult', ['Result' => $result]);
    }
    ...
    public function Refund()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->Refund($CorpNum, $RefundForm, $UserID);
            $code = $result->code;
    ...
    public function PaymentRequest()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->PaymentRequest($CorpNum, $PaymentForm);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('BizInfoCheck/PaymentResponse', ['Result' => $result]);
    }
    ...
    public function GetSettleResult()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->GetSettleResult($CorpNum, $SettleCode, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
        }
        return view('BizInfoCheck/PaymentHistory', ['Result' => $result]);
    }
    ...
    public function GetChargeURL()
    {
        ...
        try {
            $url = $this->PopbillBizInfoCheck->GetChargeURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetPaymentURL()
    {
        ...
        try {
            $url = $this->PopbillBizInfoCheck->GetPaymentURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetUseHistoryURL()
    {
        ...
        try {
            $url = $this->PopbillBizInfoCheck->GetUseHistoryURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetUnitCost()
    {
        ...
        try {
            $unitCost = $this->PopbillBizInfoCheck->GetUnitCost($CorpNum);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetPartnerBalance()
    {
        ...
        try {
            $remainPoint = $this->PopbillBizInfoCheck->GetPartnerBalance($CorpNum);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetPartnerURL()
    {
        ...
        try {
            $url = $this->PopbillBizInfoCheck->GetPartnerURL($CorpNum, $TOGO);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function GetChargeInfo()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->GetChargeInfo($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function CheckIsMember()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->CheckIsMember($CorpNum, $LinkID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function CheckID()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->CheckID($UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function GetCorpInfo()
    {
        ...
        try {
            $CorpInfo = $this->PopbillBizInfoCheck->GetCorpInfo($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function UpdateCorpInfo()
    {
        ...
        try {
            $result =  $this->PopbillBizInfoCheck->UpdateCorpInfo($CorpNum, $CorpInfo, $UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function RegistContact()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->RegistContact($CorpNum, $ContactInfo);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function GetContactInfo()
    {
        ...
        try {
            $ContactInfo = $this->PopbillBizInfoCheck->GetContactInfo($CorpNum, $ContactID, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function ListContact()
    {
        ...
        try {
            $ContactList = $this->PopbillBizInfoCheck->ListContact($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function UpdateContact()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->UpdateContact($CorpNum, $ContactInfo, $UserID);
            $code = $result->code;
            $message = $result->message;
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
    ...
    public function GetAccessURL()
    {
        ...
        try {
            $url = $this->PopbillBizInfoCheck->GetAccessURL($CorpNum, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
    ...
    public function QuitMember()
    {
        ...
        try {
            $result = $this->PopbillBizInfoCheck->QuitMember($CorpNum, $QuitReason, $UserID);
        } catch (PopbillException $pe) {
            $code = $pe->getCode();
            $message = $pe->getMessage();
            return view('PResponse', ['code' => $code, 'message' => $message]);
